async function carregarSessoes() {
    ...
    const params = "?data_fim__year=2025&data_inicio__year=2025";
    ...
    try {
        ...
        data.results.forEach(sessao => {
            ...
            // Verifica se tem link da ata.
            // OBS: Dependendo do SAPL, pode ser 'url_ata', 'texto_ata' ou estar vazio.
            // Aqui estou assumindo que o campo se chama 'texto_ata' ou url direta.
            // Se não aparecer o botão, teremos que investigar o nome exato do campo no seu SAPL.
            let botaoAta = "";
...
// Chama a função assim que ler o script
carregarSessoes();
